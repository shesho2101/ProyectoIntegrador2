...
const AdminVuelos: React.FC = () => {
    ...
    // ✅ Función para eliminar vuelo del estado
    ...
    <div className="mb-6">
      ...
      <div className="w-3/4 mx-auto mt-10">
        {filteredFlights.length === 0 ? (
          <p className="text-center">No se encontraron vuelos para los filtros aplicados.</p>
        ) : (
          filteredFlights.map((flight) => (
            ...
            >
              ...
              <div className="flex flex-col items-end">
                ...
                {/* ✅ Botón para eliminar */}
                <button
                  className="mt-2 bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-red-700 transition-all"
